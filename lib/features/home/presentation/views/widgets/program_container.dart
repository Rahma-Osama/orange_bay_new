...
class ProgramContainer extends StatelessWidget {
  ...
  final Animation<double> animation;
   ProgramContainer({Key? key, this.whishScreen=false,  required this.animationController, required this.animation}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: MediaQuery.of(context).size.height/60,left: 8,right: 8),
                child: Row(
